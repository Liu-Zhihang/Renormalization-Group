...
![Schematic Diagram of the Physical Behavior of Six Standard Critical Exponents. (a) Order Parameter M Grows as M ~ (-t)^\beta on the Low-Temperature Side; (b) Susceptibility χ Diverges as \chi ~ |t|^-\gamma at the Critical Point; (c) Specific Heat C Diverges or Shows a Cusp as C ~ |t|^-\alpha; (d) Correlation Length ξ Diverges as \xi ~ |t|^-\nu; (e) Critical Isotherm M ~ h^1/\delta Shows Nonlinear Response; (f) Correlation Function at Critical Point Decays as Power Law G(r) ~ r^-(d-2+\eta). Source: Self-Drawn](../cn/assets/images/05_001_8ee5e818-84e5-432a-b9ff-ef91260abdee.png)

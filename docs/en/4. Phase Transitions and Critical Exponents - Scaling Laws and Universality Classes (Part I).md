...
![Three Perspectives on First-Order Phase Transitions. (1) Macroscopic Thermodynamics: Entropy $S$ and Order Parameter $M$ Jump at the Transition Temperature $T_{\text{tr}}$, with the Entropy Discontinuity $\Delta S$ Corresponding to Latent Heat; (2) Free Energy Landscape: Double-Well Structure Evolves with Temperature, for $T < T_{\text{tr}}$ the Left Well Is Deeper (Phase A Stable), at $T = T_{\text{tr}}$ Both Wells Are Equally Deep (Phase Coexistence), for $T > T_{\text{tr}}$ the Right Well Is Deeper (Phase B Stable), Arrows Indicate the System's Stable Position; (3) Microscopic Configuration: In the Ordered Phase (Blue) Spins Are Nearly Parallel, in the Disordered Phase (Red) Spins Are Randomly Oriented, Two Phases Can Coexist Through Phase Interface, but the Correlation Length $\xi$ Within Each Phase Remains Finite. Source: Self-Drawn](../cn/assets/images/04_002_88fc564e-4c7e-4568-9ef7-2cbd9d4248bc.png)
...
![Three Perspectives on Continuous Phase Transitions. (1) Macroscopic Response Divergence: Susceptibility $\chi$ and Specific Heat $C$ Tend to Infinity at the Critical Temperature $T_c$, System Response to Weak Perturbations Becomes Extremely Violent; (2) Free Energy Landscape: for $T > T_c$ Single Well (Disordered Phase), at $T = T_c$ the Well Bottom Is Completely Flat (Zero Curvature, Fluctuations Cost Nothing), for $T < T_c$ Double Well (Ordered Phase, Spontaneous Symmetry Breaking); (3) Microscopic Configuration and Correlation Length Divergence: At Critical Point Spins Form Fractal Structures Spanning the Entire System (Blue and Red Regions), Correlation Length $\xi \sim |T - T_c|^{-\nu} \to \infty$, Local Perturbations Can Propagate to Arbitrary Distances. Source: Self-Drawn](../cn/assets/images/04_001_69ca0e9e-d7df-49ef-8901-c7c0a2f8c2ee.png)

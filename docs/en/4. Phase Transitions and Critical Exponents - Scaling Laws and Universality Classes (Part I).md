...
![Three Perspectives on First-Order Phase Transitions. (1) Macroscopic Thermodynamics: Entropy S and Order Parameter M Jump at the Transition Temperature Tₜr, with the Entropy Discontinuity Δ S Corresponding to Latent Heat; (2) Free Energy Landscape: Double-Well Structure Evolves with Temperature, for T < Tₜr the Left Well Is Deeper (Phase A Stable), at T = Tₜr Both Wells Are Equally Deep (Phase Coexistence), for T > Tₜr the Right Well Is Deeper (Phase B Stable), Arrows Indicate the System's Stable Position; (3) Microscopic Configuration: In the Ordered Phase (Blue) Spins Are Nearly Parallel, in the Disordered Phase (Red) Spins Are Randomly Oriented, Two Phases Can Coexist Through Phase Interface, but the Correlation Length ξ Within Each Phase Remains Finite. Source: Self-Drawn](../cn/assets/images/04_002_88fc564e-4c7e-4568-9ef7-2cbd9d4248bc.png)
